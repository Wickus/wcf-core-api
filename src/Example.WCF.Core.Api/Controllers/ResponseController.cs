...
namespace Example.WCF.Core.Api.Controllers
{
	[Route("api/response")]
	[ApiController]
	public class ResponseController(ISoapService soapService, ISoapFaultService soapFaultService, ISoapValidationService soapValidationService) : ControllerBase
	{
